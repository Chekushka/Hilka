...
| Grade 7 sem-2 block: intro → loops-for + turtle-basics | 🔶 | All 9 topics in this range now have 2–3 tasks each instead of 1 (intro 3, variables 3, arithmetic 3, linear 3, turtle-basics 3, conditions 3, turtle-conditions 2, loops-while 3, loops-for 3) — real practice, but still short of the ~12/topic CURRICULUM.md sizes a full lesson at. More per topic is still open, especially turtle-conditions. |
