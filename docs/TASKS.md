...
| Grade 7 sem-2 block: intro → loops-for + turtle-basics | 🔶 | Every one of the 9 topics in this range (intro, variables, arithmetic, linear, turtle-basics, conditions, turtle-conditions, loops-while, loops-for) now has at least one published task — one apiece is a start, not a full lesson's worth; more per topic is still open. |
